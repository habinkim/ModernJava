...
public class WorkingWithCollections {
	...
	private static void workingWithMaps() {
		...
		Map<String, String> favouriteMovies = Map.ofEntries(
				java.util.Map.entry("Raphael", "Star Wars"),
				java.util.Map.entry("Cristina", "Matrix"),
				java.util.Map.entry("Olivia", "James Bond")
				);
	...
	private static void computingOnMaps() {
		...
		System.out.println("--> Adding a friend and movie using computOfAbsent()");
	...
	private static void mergingMaps() {
		Map<String, String> family = Map.ofEntries(
				java.util.Map.entry("Teo", "Star Wars"),
				java.util.Map.entry("Cristina", "James Bond"));
		Map<String, String> friends = Map.ofEntries(java.util.Map.entry("Raphael", "Star Wars"));
